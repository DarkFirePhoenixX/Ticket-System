          ...
          <div class="row g-0">
            <div class="col-lg-6">
              <div class="card-body">
                ...
                @csrf
                  <p class="fs-5"><b><i>Please provide your email</i></b></p>
                  ...
                  <div>Forgotten your password? No worries. Just fill in your email below and we will send you a password reset link.</div>
                  <div class="text-center pt-1 mt-3 pb-1">
                    <button class="btn btn-primary btn-block fa-lg gradient-custom-2 mb-3" type="submit">{{ __('Send password recovery email') }}</button>
                  </div>
                </form>
